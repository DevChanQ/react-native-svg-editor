...
*/
  ...
  let regex = new RegExp(this.cssCommentsRegex, 'gi');
...
*/
  ...
  let keyframesRegex = new RegExp(this.cssKeyframeRegex, 'gi');
  let arr;
  while (true) {
  ...
  //unified regex
  let unified = new RegExp(this.combinedCSSRegex, 'gi');
  ...
  while (true) {
    ...
    */
    let commentsRegex = new RegExp(this.cssCommentsRegex, 'gi');
...
*/
  ...
  let __el = document.getElementById(id);
  if (__el) {
